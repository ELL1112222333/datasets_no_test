...
#input_label_dir = 'E:/datasets_no_test/datasets_no_test/train/labels_no_error_mathpix/'
input_label_dir = 'E:/datasets_no_test/datasets_no_test/dev/labels_no_error_mathpix/'
#output_label_dir = './data/math_210421/formula_labels_210421_no_chinese/'
#output_label_dir ='E:/datasets_no_test/datasets_no_test/train/labels_no_chinese/'
output_label_dir ='E:/datasets_no_test/datasets_no_test/dev/labels_no_chinese/'

label_name_list = os.listdir(input_label_dir)

with open('E:/datasets_no_test/datasets_no_test/vocab.txt', 'r', encoding='utf-8') as f:
    vocab = f.read().split()
...
for label_name in label_name_list:
    ...
    if have_chinese is not True:
        ...
        with open('E:/datasets_no_test/datasets_no_test/chinese/' + label_name, 'w', encoding='utf-8') as f:
            f.write(new_content)
...
with open('E:/datasets_no_test/datasets_no_test/chinese_token.txt', 'w', encoding='utf-8') as f:
