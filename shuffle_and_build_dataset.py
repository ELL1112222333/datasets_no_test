...
'''
# shuffle end
input_dir = 'E:/datasets_no_test/datasets_no_test/train/labels_no_chinese/'
output_dir = 'E:/datasets_no_test/datasets_no_test/'
#input_dir = 'E:/datasets_no_test/datasets_no_test/dev/labels_no_chinese/'
#output_dir = 'E:/datasets_no_test/datasets_no_test/'
#image_input_dir = 'E:/datasets_no_test/datasets_no_test/dev/formula_images_210421/'
#image_output_dir = 'E:/datasets_no_test/datasets_no_test/dev/'
image_input_dir = 'E:/datasets_no_test/datasets_no_test/train/formula_images_210421/'
image_output_dir = 'E:/datasets_no_test/datasets_no_test/train/'


label_name_list = os.listdir(input_dir)

for i in range(len(label_name_list)):
    label_name_list[i] = label_name_list[i]



with open(output_dir + 'train.formulas.norm.txt', 'w', encoding='utf-8') as f1:
#with open(output_dir + 'dev.formulas.norm.txt', 'w', encoding='utf-8') as f1:
    for i in range(len(label_name_list)):
        if i %10000==0:
            print(i)
        train_label_name = label_name_list[i]
        image_name = train_label_name[:-4] + '.png'
        #shutil.copy(image_input_dir + image_name, image_output_dir + 'images_dev/' + str(i) + '.png')
        shutil.copy(image_input_dir + image_name, image_output_dir + 'images_train/' + str(i) + '.png')
        with open(input_dir + train_label_name, 'r', encoding='utf-8') as f2:
            line = f2.read()
            f1.write(line + '\n')
